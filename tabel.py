...
class ImageClassificationApp(QMainWindow):
    ...
    def initUI(self):
        ...
        self.select_folder_button.setGeometry(260, 50, 200, 40)
        self.select_folder_button.clicked.connect(self.processImages)
        ...
        # 표 헤더 설정
        table_header = ["No", "Original Label", "Predicted Label", "Accuracy", "Result"]
    ...
    def processImages(self):
        ...
        if folder:
            ...
            for image_file in image_files:
                ...
                pred = np.argmax(pred_classes, axis=0)
            ...
            self.log_text.appendPlainText(f"\nImage processing completed. Processed {total_images} images.")
            self.log_text.appendPlainText(f"Matched: {match_count} images out of {total_images} (Accuracy: {accuracy_percentage:.2f}%)")
