...
from PyQt5.QtGui import QPixmap, QImage, QImageReader,QIcon,QFont
...
class ImageClassificationApp(QMainWindow):
    ...
    def initUI(self):
        ...
        #Window 창 설정
        self.setWindowIcon(QIcon("logo/ap1.png")) 
        self.setWindowTitle("Wafer Image Defect Classification")
        self.setGeometry(100, 100, 1400, 900)
        self.setStyleSheet("background-color: lightgray;")
        
        #상단 프로그램 제목 레이블
        self.label1=QLabel(self)
        self.label1.setGeometry(570, 15, 700, 50)
        self.label1.setText("Wafer Image Defect Classification")
        ...
        scroll_area_style = """
                QScrollArea {
                    border: 2px solid rgb(58, 134, 255); /* 2px 굵기의 테두리 */
                }
                """
        # 그래프 위젯 초기화
        self.graph_widget = QScrollArea(self)
        self.graph_widget.setGeometry(460, 70, 900, 600)
        self.graph_layout = QVBoxLayout(self.graph_widget)
        self.graph_widget.setWidgetResizable(True)
        self.graph_widget.setStyleSheet(scroll_area_style)
        ...
        self.classify_button.setGeometry(250, 370, 200, 40)
        ...
        self.load_model_button.setGeometry(50, 370, 200, 40)
        ...
        self.log_widget.setGeometry(50, 442, 400, 400)
        ...
        self.log_widget.setStyleSheet(scroll_area_style)
        ...
        self.image_display.setGeometry(50, 60, 400, 130)  # 이미지 크기 및 위치 조절
    ...
    def loadModel(self):
        ...
        model_path, _ = QFileDialog.getOpenFileName(
            self, "Open Model File", "", "Model Files (*.h5);;All Files (*)", options=options
        )
